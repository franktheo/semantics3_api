class BackgroundJobs
  ...
  def perform(search_terms)
    ...
    Rails.cache.fetch(search_terms, :expires_in => 8.minute) do
    ...
    #puts "products: " + $products[0]["name"].inspect
    #puts "cached data: " + Rails.cache.fetch(search_terms)[0]["name"].inspect
  end
